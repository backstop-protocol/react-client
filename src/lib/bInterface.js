...
const collateralFactor = { [ETH_A_ILK] : 1.5, [ETH_B_ILK] : 1.3, [WBTC_A_ILK] : 1.5 }
...
{
    "INFO_ADDRESS" : "0x6CFb127af9a17FD56536F53Be93e00169c63BC59",
...
function getJoinAddress(ilk, networkId) {
  ...
  if(ilk === WBTC_A_ILK) return getAddress("MCD_JOIN_WBTC_A", networkId)
