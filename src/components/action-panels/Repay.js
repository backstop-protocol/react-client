      ...
      <div className="currency-action-panel">
        ...
        <div className="currency-input">
          <div className="tooltip-container">
            <div className="set-max" onClick={this.setMax}>
              Set Max
            </div>
            <input
              type="text"
            ...
            />
            {error && (
              <Tooltip bottom={true} className={"warning"}>
                {error}
              </Tooltip>
            )}
          </div>
          <button
            className={invalid || locked || !(val * 1) ? "disabled" : ""}
        ...
        <div className="currency-secondary-input">
          ...
          <div
            className={
              "tickbox" + (unlocking ? " loading" : locked ? "" : " active")
            }
