...
export default function Pulser() {
    return (
        <svg className="pulser" xmlns="http://www.w3.org/2000/svg" width="487" height="294" viewBox="0 0 487 294">
            <defs>
            ...
            <g fill="none" fillRule="evenodd">
                <g>
                    <g transform="translate(-461 -103) translate(461 105)">
                        <circle cx="250" cy="145" r="145" stroke="url(#ehosr7uxja)" strokeWidth="2.4" opacity=".219" />
                        <circle cx="250" cy="145" r="124" stroke="url(#ehosr7uxja)" strokeWidth="2.4" opacity=".15" transform="rotate(-90 250 145)"/>
                        <circle cx="250.5" cy="145.5" r="104.5" stroke="url(#ehosr7uxja)" strokeWidth="2.4" opacity=".15" transform="rotate(-90 250.5 145.5)"/>
                        ...
                        <circle cx="250" cy="146" r="71.8" stroke="rgba(255,255,255,0.15)" strokeWidth="2.4" opacity=".1"/>
                        <circle cx="250" cy="146" r="47.8" stroke="rgba(255,255,255,0.25)" strokeWidth="2.4" opacity=".1"/>
                    </g>
                </g>
            </g>
        </svg>
