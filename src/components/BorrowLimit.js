  ...
  render() {
    ...
    return (
      <div className="borrow-limit">
        <h3 style={{ fontWeight: 500, color: "#0b0412" }}>Borrow Limit</h3>
        <div className="limit-bar">
          <label>{userInfo ? numm(userInfo.bCdpInfo.daiDebt) : 0} DAI</label>
          <div className="limit-bar-inner">
            <div
              className="limit-bar-track"
              style={{
                width:
                  (userInfo && userInfo.bCdpInfo.maxDaiDebt
                    ? (userInfo.bCdpInfo.daiDebt /
                        userInfo.bCdpInfo.maxDaiDebt) *
                      100
                    : 0) + "%",
              }}
            >
