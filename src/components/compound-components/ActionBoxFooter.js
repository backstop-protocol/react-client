            ...
            <Container>
                <Flex>
                    <Flex column justifyBetween className="grey-divider" style={{width: "30%"}}>
                        ...
                        <Amount id={`wallet-balance-${symbol}`}>{displayNum(WalletBalanceStr, 4)} {symbol}</Amount>
                    </Flex >
                    <Flex column justifyBetween className="grey-divider" style={{width: "30%"}}>
                        <SmallTitle>Total deposit</SmallTitle>
                        <Amount id={`${action}-${symbol}-calculated-total-deposit-in-usd`}>${updatedTotalDeposit}</Amount>
                    </Flex >
