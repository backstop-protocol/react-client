...
//       this.setState({
//         ratingProgress:
//           parseFloat(userInfo.userRatingInfo.userRatingProgressPerSec) /
//           ratingFactor,
//       });
//       this.setState({
//         currentRating: parseFloat(
//           userInfo.userRatingInfo.userRating / ratingFactor
//         ).toFixed(7),
//       });
//     }

//     const currRatingProgress =
//       parseFloat(userInfo.userRatingInfo.userRatingProgressPerSec) /
//       ratingFactor;
...
//       currentRating * 1 + this.state.ratingProgress * 3
//     );
...
//                 value={
//                   userInfo
//                     ? userInfo.userRatingInfo.jarBalance === 0
//                       ? 10000
//                       : userInfo.userRatingInfo.jarBalance *
//                         userInfo.miscInfo.spotPrice
//                     : 10000
//                 }
//               />
//             </div>
...
//                     {numm(
//                       userInfo
//                         ? userInfo.userRatingInfo.totalRating / ratingFactor
//                         : 0,
//                       2
//                     )}
//                   </h3>
...
export default class GlobalStats extends Component {
  ...
  render() {
    const { userInfo } = this.props;
    const { currentRating } = this.state;
    if (this.state.ratingInterval == null) {
      const interval = setInterval(this.updateUserRating, 3000);
      ...
      <div className="global-stats even">
        <div className="stats">
          ...
          <div className="right">
            ...
            <div className="value">
              <Ticker value={currentRating} primary={5} />
            </div>
          </div>
        </div>
        <div className="image-container">
